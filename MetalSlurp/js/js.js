function start(){
//Sintaxe JQ para selecionar a div "inicio"
    $("#inicio").hide();
    ...
    var perdidos=0;
    var energiaAtual=3;
    /*Usar javascripts para evitar problemas compatibilidade com Jquery*/
    ...
    function explosao1(inimigo1X,inimigo1Y){
        somExplosao.play();
         ...
         div.animate({width:200, opacity:15}, "slow");
    ...
    function explosao2(inimigo2X,inimigo2Y){
        somExplosao.play();
         ...
         div2.animate({width:200, opacity:15}, "slow");
    ...
    function reposicionaInimigo1(){
        var tempoColisao4=window.setInterval(reposciona4,Math.random()*3000);
        function reposciona4(){
    ...
    function reposicionaInimigo2(){
        var tempoColisao4=window.setInterval(reposciona4,5000);
        function reposciona4(){
            window.clearInterval(tempoColisao4);
            tempoColisao4=null;
            if(fimdejogo==false){
    ...
    function reposicionaAmigo(){
        var tempoAmigo=window.setInterval(reposciona6,6000);
        function reposciona6(){
